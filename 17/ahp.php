<head>
    ...
    <div>
        ...
        <h3><b>Menghitung CR</b></h3>
        <h4><b>Menghitung Matriks</b></h2>
            <?php
            // perhitungan matriks
            ...
            <h4><b>Menghitung λmaks dan CI</b></h4>
            <?php
            // menghitung λmaks
    ...
    <div>
        ...
        <hr>
        <hr>
        <h2><b>Tabel Alternatif Pasar</b></h2>
        <table class="table table-bordered" border="1">
            <tr style="background-color: aqua">
                <th>pasar</th>
                <th>Atlanta</th>
    ...
    <div>
        ...
        <hr>
        <hr>
        <h2><b>Tabel Alternatif Pendapatan</b></h2>
        <table class="table table-bordered" border="1">
            <tr style="background-color: aqua">
                <th>pendapatan</th>
                <th>Atlanta</th>
    ...
    <div>
        ...
        <hr>
        <hr>
        <h2><b>Tabel Alternatif Infrastruktur</b></h2>
        <table class="table table-bordered" border="1">
            <tr style="background-color: aqua">
                <th>infrastruktur</th>
                <th>Atlanta</th>
    ...
    <div>
        ...
        <hr>
        <hr>
        <h2><b>Tabel Alternatif Transportasi</b></h2>
        <table class="table table-bordered" border="1">
            <tr style="background-color: aqua">
                <th>transportasi</th>
                <th>Atlanta</th>
    ...
    <div>
        ...
        ?>
        <h3><b>Pengampilan Keputusan</b></h3>
        <table class="table table-bordered" border="1">
            <tr style="background-color: aqua">
                <th></th>
                <th>pasar</th>
        ...
        <?php
        if ($pk1 > $pk2) {
            echo ("<h3><b>Hasil CR: " . $pk1 . "</b></h3>");
            echo ("<h3><b>Pilihan yang terpilih adalah Alternatif 1 yaitu Atlanta</b></h3>");
        }
        if ($pk2 > $pk3) {
            echo ("<h3><b>Hasil CR: " . $pk2 . "</b></h3>");
            echo ("<h3><b>Pilihan yang terpilih adalah Alternatif 2 yaitu Birmingham</b></h3>");
        } else {
            echo ("<h3><b>Hasil CR: " . $pk3 . "</b></h3>");
            echo ("<h3><b>Pilihan yang terpilih adalah Alternatif 3 yaitu Charlotte</b></h3>");
        }
