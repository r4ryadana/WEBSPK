<head>
  ...
  <br>
      <?php
        ...
        $c44 = 1;
        ?>
        <h3 class="text-center"><b><i>Hitung Kriteria</b></i></h3>
        ...
        <br>
        <h3>Penyelesaian 2 : Menghitung CR</h3>
        <?php
            // perhitungan matriks
            ...
            <br>
            <h3>Penyelesaian 3 : Menghitung λmaks dan CI</h3>
            <?php
            // menghitung λmaks
  ...
  <div class="row">
  <br>
      <h3 class="text-center"><i><b>Alternatif Pasar<b></i></h3>
      <?php
        // Atlanta
        $a1c11 = 1;
        $a1c12 = 4;
        ...
        <h3>Penyelesaian 2 : Menghitung CR</h3>
            ...
            <br>
      <h3 class="text-center"><i><b>Alternatif Pendapatan</b></i></h3>
      <?php
        // Atlanta
        $a2c11 = 1;
        $a2c12 = 1 / 6;
        ...
        $a2c33 = 1;
        ?>
        <h3>Tabel Alternatif Pendapatan</h3>
        <table class="table table-bordered" border="1">
        <tr style="background-color: #FFE4E1">
                <th>Pendapatan</th>
                <th>Atlanta</th>
        ...
        <h3>Penyelesaian 2 : Menghitung CR</h3>
            ...
            <br>
      <h3 class="text-center"><b><i>Alternatif Infrastruktur</b></i></h3>
      <?php
        // Atlanta
        $a3c11 = 1;
        $a3c12 = 1 / 3;
        ...
        $a3c33 = 1;
        ?>
        <h3>Tabel Alternatif Infrastruktur</h3>
        <table class="table table-bordered" border="1">
        <tr style="background-color: #FFE4E1">
                <th>Infrastruktur</th>
                <th>Atlanta</th>
        ...
        <h3>Penyelesaian 2 : Menghitung CR</h3>
            ...
            <br>
      <h3 class="text-center"><b><i>Alternatif Transportasi</b></i></h3>
      <?php
        // Atlanta
        $a4c11 = 1;
        $a4c12 = 1 / 2;
        ...
        $a4c33 = 1;
        ?>
        <h3>Tabel Alternatif Transportasi</h3>
        <table class="table table-bordered" border="1">
        <tr style="background-color: #FFE4E1">
                <th>Transportasi</th>
                <th>Atlanta</th>
        ...
        <h3>Penyelesaian 2 : Menghitung CR</h3>
            ...
            <br>
      <h3 class="text-center"><b><i>Pengambilan Keputusan</b></i></h3>
      <?php
        ...
        <?php
        if ($pk1 > $pk2) {
            echo ("<h4><b>Hasil CR: " . $pk1 . "</b></h4>");
            echo ("<h4>Kesimpulan dari hasil yang di dapat menggunakan penyelesaian metode ELECTREE diatas adalah : <h2><center>'Alternatif 1 = Atlanta'</center></h2></h4>");
        }
        if ($pk2 > $pk3) {
            echo ("<h4><b>Hasil CR: " . $pk2 . "</b></h4>");
            echo ("<h4>Kesimpulan dari hasil yang di dapat menggunakan penyelesaian metode ELECTREE diatas adalah : <h2><center>'Alternatif 2 = Birmingham'</center></h2></h4>");
        } else {
            echo ("<h4><b>Hasil CR: " . $pk3 . "</b></h4>");
            echo ("<h4>Kesimpulan dari hasil yang di dapat menggunakan penyelesaian metode ELECTREE diatas adalah : <h2><center>'Alternatif 3 = Charlotte'</center></h2></h4>");
        }
